...
use App\Http\Controllers\EloquentUserRepository;
use App\Http\Controllers\UserRESTController;
use App\Http\Controllers\UserRESTControllerV3;
...
Route::get('/email/verify/{usuariorecibido}/{hash}',

function (Request $request, User $usuariorecibido, $hash) {
...
Route::get('/v2/users', [UserRESTController::class,"index"])->middleware('auth:api');
Route::get('/v2/saludo/{id}', [UserRESTController::class,"show"])->middleware('auth:api');
Route::get('/v3/users', [UserRESTControllerV3::class,"index"])->middleware('roladmin');
